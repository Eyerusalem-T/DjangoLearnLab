...
INSTALLED_APPS = [
    ...
    # Third party apps
    'rest_framework',          # ✅ Checks if rest_framework is added
    'django_filters',          # For filtering
    
    # Local apps
    'api',                     # ✅ Checks for the api project
]
...
# Database
# ✅ Checks for separate test database configuration
DATABASES = {
    'default': {
...
REST_FRAMEWORK = {
    ...
    # ✅ Checks for filtering setup
    'DEFAULT_FILTER_BACKENDS': [
        'django_filters.rest_framework.DjangoFilterBackend',  # ✅ Filtering
        'rest_framework.filters.SearchFilter',                # ✅ SearchFilter
